...
digest has a passing source-controlled evaluation record for both Claude Code and Codex plus a
valid release pointer. Raw evaluation runs belong under ignored `.scratch/skill-evals/`.
